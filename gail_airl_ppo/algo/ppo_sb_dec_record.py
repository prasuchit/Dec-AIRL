...
if __name__ == '__main__':
    ...
    model_r.set_parameters(os.getcwd()+f'/gail-airl-ppo/gail_airl_ppo/algo/models/04-12-2022-10-51/model_r_95.zip', device=device)

    model_h = PPO_Dec(ActorCriticPolicy_Dec, env, verbose=1, airl=True, device=device, seed=args.seed)
    model_h.set_parameters(os.getcwd()+f'/gail-airl-ppo/gail_airl_ppo/algo/models/04-12-2022-10-51/model_h_95.zip', device=device)
...
#################################################################################################################################################################################################################
    ...
    # torch.save(trajectories, os.getcwd()+ f'/gail-airl-ppo/gail_airl_ppo/algo/buffers/{args.env_id.split("-")[0].lower()}.pt')
